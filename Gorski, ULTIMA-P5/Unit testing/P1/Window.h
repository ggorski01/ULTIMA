...
Window::Window()
{
    ...
    write_window(Heading_Win, 9, 2, " Press 'q' or Ctrl-C to exit the program...\n   Press 'p' pause or 'r' resume...\n");
    //end of Heading Window

    //Starting Log_Win
    Log_Win = create_window(15, 60, 25, 2);
    write_window(Log_Win, 1, 5, ".......Log....\n");

    
    Tb_Win = create_window(8, 60, 40, 2);
    Tb_Win1 = create_window(3, 60, 47, 2);
    write_window(Tb_Win, 1, 5, ".......Process Table....\n");


    Console_Win = create_window(15, 23, 25, 62);
    write_window(Console_Win, 1, 1, "....Console....\n");
    write_window(Console_Win, 2, 1, "....h for help....\n");

    Sem_Win = create_window(10, 23, 40, 62);

    Misc_Table = create_window(47, 110, 3, 85);
...
void Window::display_help(WINDOW *Win)
{
    ...
    write_window(Win, 2, 1, "0= Kill 0");
    write_window(Win, 3, 1, "1= Kill 1");
    write_window(Win, 4, 1, "2= Kill 2");
...
void Window::cont_help(WINDOW *Win)
{
    ...
    write_window(Win, 6, 1, "u= Filesystem");
    write_window(Win, 7, 1, "b= Back to previous");
}
//----------------------------------------
